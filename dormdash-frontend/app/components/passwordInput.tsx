...
export default function PasswordInput({onPassChange}:Props){
    return <TextInput placeholder="password" style={loginStyle().input} importantForAutofill="yes" enterKeyHint="done" enablesReturnKeyAutomatically={false} autoComplete="current-password" onChangeText={
